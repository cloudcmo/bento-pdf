import{n as e,t}from"./style-BqFvd6MF.js";import{L as n,k as r,w as i}from"./main-CTXic8Nn.js";import{t as a}from"./pdf-decrypt-BFCnDXvq.js";var o=null,s=null;function c(e){return document.getElementById(e)}function l(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function u(){let e=c(`password-modal`);return e||(e=document.createElement(`div`),e.id=`password-modal`,e.className=`fixed inset-0 bg-black/70 backdrop-blur-sm z-[100] hidden items-center justify-center p-4`,e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),e)}function f(e,t){return new Promise(r=>{let a=!1,o=i({data:e.slice(0),password:t});o.onPassword=(e,t)=>{a||(a=!0,r(t!==n.INCORRECT_PASSWORD),o.destroy().catch(()=>{}))},o.promise.then(e=>{e.destroy(),a||(a=!0,r(!0))}).catch(()=>{a||(a=!0,r(!1))})})}async function p(e){let t=await r(e);return new Promise(e=>{let n=!1,r=i({data:t.slice(0)});r.onPassword=()=>{n||(n=!0,e(!0),r.destroy().catch(()=>{}))},r.promise.then(t=>{t.destroy(),n||(n=!0,e(!1))}).catch(()=>{n||(n=!0,e(!1))})})}async function m(e,t){let n=await r(e),i=await a(new Uint8Array(n),t);return new File([new Uint8Array(i.bytes)],e.name,{type:`application/pdf`})}async function h(n){s&&await s;let i=await r(n);if(o)if(await f(i,o))try{return await m(n,o)}catch{o=null}else o=null;let a=u(),l=c(`password-modal-input`),d=c(`password-modal-title`),p=c(`password-modal-subtitle`),h=c(`password-modal-error`),g=c(`password-modal-progress`),_=c(`password-modal-submit`),v=c(`password-modal-cancel`),y=c(`password-modal-toggle`);if(!l||!_||!v)return null;d&&(d.textContent=`Password Required`),p&&(p.textContent=n.name),h&&(h.textContent=``,h.classList.add(`hidden`)),g&&(g.textContent=``,g.classList.add(`hidden`)),l.value=``,l.type=`password`,_.disabled=!1,_.textContent=`Unlock`,_.dataset.originalText=`Unlock`,v.disabled=!1,v.textContent=`Skip`,a.classList.remove(`hidden`),a.classList.add(`flex`),t({icons:e}),setTimeout(()=>l.focus(),100);let b=new Promise(r=>{let s=!1,c=!1;function u(){a.classList.add(`hidden`),a.classList.remove(`flex`),_.removeEventListener(`click`,p),v.removeEventListener(`click`,b),l.removeEventListener(`keydown`,x),y&&y.removeEventListener(`click`,S)}function d(e){s||(s=!0,u(),r(e))}async function p(){if(c)return;let e=l.value;if(!e){h&&(h.textContent=`Please enter a password`,h.classList.remove(`hidden`));return}if(h&&h.classList.add(`hidden`),c=!0,_.disabled=!0,v.disabled=!0,g&&(g.textContent=`Validating...`,g.classList.remove(`hidden`)),!await f(i,e)){c=!1,_.disabled=!1,v.disabled=!1,g&&g.classList.add(`hidden`),l.value=``,l.focus(),h&&(h.textContent=`Incorrect password. Please try again.`,h.classList.remove(`hidden`));return}g&&(g.textContent=`Decrypting...`);try{let t=await m(n,e);o=e,g&&g.classList.add(`hidden`),d(t)}catch{c=!1,_.disabled=!1,v.disabled=!1,g&&g.classList.add(`hidden`),h&&(h.textContent=`Failed to decrypt. Try the Decrypt tool instead.`,h.classList.remove(`hidden`))}}function b(){c||d(null)}function x(e){e.key===`Enter`?(e.preventDefault(),p()):e.key===`Escape`&&(e.preventDefault(),b())}function S(){let n=l.type===`password`;l.type=n?`text`:`password`;let r=y?.querySelector(`i[data-lucide]`);r&&r.setAttribute(`data-lucide`,n?`eye-off`:`eye`),t({icons:e})}_.addEventListener(`click`,p),v.addEventListener(`click`,b),l.addEventListener(`keydown`,x),y&&y.addEventListener(`click`,S)});return s=b,b.finally(()=>{s===b&&(s=null)}),b}async function g(n,i){s&&await s;let a=new Map;if(i.length===0)return a;if(i.length===1){let e=i[0],t=await h(n[e]);return t&&a.set(e,t),a}if(o){let e=!0;for(let t of i)if(!await f(await r(n[t]),o)){e=!1,o=null;break}if(e&&o){let e=new Map,t=!0;for(let r of i)try{e.set(r,await m(n[r],o))}catch{o=null,t=!1;break}if(t&&e.size===i.length){for(let[t,n]of e)a.set(t,n);return a}}}let u=i.map(e=>n[e].name),p=d(),g=c(`batch-modal-title`),_=c(`batch-modal-same-pw`),v=c(`batch-modal-shared`),y=c(`batch-modal-shared-input`),b=c(`batch-modal-shared-toggle`),x=c(`batch-modal-filelist`),S=c(`batch-modal-error`),C=c(`batch-modal-progress`),w=c(`batch-modal-submit`),T=c(`batch-modal-cancel`);if(!w||!T||!_||!y||!x)return a;g&&(g.textContent=`${u.length} Files Need a Password`),_.checked=!0,y.value=``,y.type=`password`,v&&v.classList.remove(`hidden`),x.classList.add(`hidden`),x.innerHTML=u.map((e,t)=>`<div class="flex items-center gap-2 p-2 bg-gray-700/50 rounded-lg transition-all" data-file-idx="${t}">
